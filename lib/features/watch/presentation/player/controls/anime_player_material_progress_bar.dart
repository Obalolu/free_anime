// ignore_for_file: implementation_imports,use_super_parameters,library_private_types_in_public_api
...
class AnimePlayerMaterialVideoProgressBar extends StatefulWidget {
  AnimePlayerMaterialVideoProgressBar(
    this.controller,
    this.betterPlayerController, {
    AnimePlayerProgressColors? colors,
    this.onDragEnd,
    this.onDragStart,
    this.onDragUpdate,
    this.onTapDown,
    Key? key,
  })  : colors = colors ?? AnimePlayerProgressColors(),
        super(key: key);

  final VideoPlayerController? controller;
  final BetterPlayerController? betterPlayerController;
  final AnimePlayerProgressColors colors;
...
class _VideoProgressBarState
    extends State<AnimePlayerMaterialVideoProgressBar> {
