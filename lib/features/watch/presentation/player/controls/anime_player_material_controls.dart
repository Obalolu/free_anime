// ignore_for_file: implementation_imports,use_super_parameters,no_leading_underscores_for_local_identifiers,sized_box_for_whitespace,avoid_unnecessary_containers

import 'dart:async';
import 'package:better_player_enhanced/better_player.dart';
import 'package:better_player_enhanced/src/video_player/video_player.dart';
import 'package:free_anime/features/watch/presentation/player/controls/anime_player_clickable_widget.dart';
import 'package:free_anime/features/watch/presentation/player/controls/anime_player_controls_state.dart';
import 'package:free_anime/features/watch/presentation/player/controls/anime_player_material_progress_bar.dart';
import 'package:free_anime/features/watch/presentation/player/controls/anime_player_progress_colors.dart';
import 'package:better_player_enhanced/src/core/better_player_utils.dart';

// Flutter imports:
import 'package:flutter/material.dart';

class AnimePlayerMaterialControls extends StatefulWidget {
  ...
  const AnimePlayerMaterialControls({
    Key? key,
  ...
  State<StatefulWidget> createState() {
    return _AnimePlayerMaterialControlsState();
  }
}

class _AnimePlayerMaterialControlsState
    extends AnimePlayerControlsState<AnimePlayerMaterialControls> {
  ...
  Widget _buildTopActionButton({
    ...
    return AnimePlayerMaterialClickableWidget(
      onTap: () {
        cancelAndRestartTimer();
        onTap();
      },
      child: Padding(
        ...
        child: Icon(icon, color: _controlsConfiguration.iconsColor),
      ),
    );
  }
  ...
  Widget _buildExpandButton() {
    return Padding(
      ...
      child: AnimePlayerMaterialClickableWidget(
  ...
  Widget _buildProgressBar() {
    return Expanded(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(horizontal: 12),
        child: AnimePlayerMaterialVideoProgressBar(
          _controller,
          _betterPlayerController,
          onDragStart: () {
            _hideTimer?.cancel();
          ...
          colors: AnimePlayerProgressColors(
